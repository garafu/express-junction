...
/**
 * Get whether the user is matched with specified rules.
...
/**
 * Get whthet the role is matched with specified rules.
 * @param   {Request}       request         Request object of express.
 * @param   {string[]}      roles           Role name list.
 */
...
/**
 * Get whether the specified string is included or not.
